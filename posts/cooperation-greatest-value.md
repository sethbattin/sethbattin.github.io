...
<details><summary>In fact...</summary>
...
one that says "national safety award 195-", but the usage instructions) reads
"not more than 25% carbon tetrachloride".  And obviously the container has some
mass; i'll guess half a kilogram.  So here's my estimate:
...
So what to say to that uncle of yours who thinks "weathermen can't even predict
